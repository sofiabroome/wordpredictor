...
\rhead{S. Broom\'e, J. Krebs, V. Geffrier, E. Fredriksen}
...
\begin{abstract}
An investigation of how we can improve word prediction with n-gram models applied to both fiction and scientific corpora by adding smoothing techniques and grammar constraints.
\end{abstract}
