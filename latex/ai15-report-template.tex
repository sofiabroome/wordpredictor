...
\subsection{Outline}
The report starts with an introduction to n-grams and its role in natural language processing. Three sections concerning n-gram models, n-gram models with smoothing and n-gram models with grammar constraints follow, where each one contains some theory and an account of our related experiments. In the end, the results of our work are presented with a subsequent discussion.
